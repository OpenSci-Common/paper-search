...
class IEEEConnector(PaperConnector):
    ...
    capabilities = ConnectorCapabilities(search=True, download=True, read=True, requires_key="IEEE_API_KEY")
    ...
    def __init__(self) -> None:
        ...
        if not self.api_key:
            logger.warning(
                "IEEEConnector initialised without PAPER_SEARCH_MCP_IEEE_API_KEY/IEEE_API_KEY.  "
