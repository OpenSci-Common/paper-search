...
class ACMConnector(PaperConnector):
    ...
    capabilities = ConnectorCapabilities(search=True, download=True, read=True, requires_key="ACM_API_KEY")
    ...
    def __init__(self) -> None:
        ...
        if not self.api_key:
            logger.warning(
                "ACMConnector initialised without PAPER_SEARCH_MCP_ACM_API_KEY/ACM_API_KEY.  "
